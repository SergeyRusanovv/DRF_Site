...
SECRET_KEY = 'django-insecure-pngkx$rr@m6$u8iip1e8hjr!hoc(jo6z$uq3um2ybh^&f8@a0$'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'My example API Project',
    'DESCRIPTION': 'My project for learning to work with drf',
    'VERSION': '1.0.0',
